...
$finish_com_result = getAllDoc_com_finish();
?>
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  foreach ($finish_com_result as $key => $value) : ?>
                    <tr>
                      ...
                      <td>
                        <h5><span class="badge rounded-pill bg-success fw-normal">สำเร็จ</span></h5>
                      </td>
                      <td class="text-end">
                        <a href="com-show-doc.php?doc_no=<?php echo $value["doc_no"]; ?>"><button type="button" class="btn btn-primary"><i class="bi bi-list-ul me-1"></i>ข้อมูล</button></a>
                      </td>
