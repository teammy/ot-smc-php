                ...
                <tbody>
                  ...
                  foreach ($onjob_result as $key => $value) : ?>
                    <tr>
                      ...
                      <td>
                        <h5>
                          <span class="badge rounded-pill bg-danger fw-normal">กำลังดำเนินการ</span>

                        </h5>
                      </td>
                      <td class="text-end">

                        <a class="btn btn-primary" role="button" href="com-to-dc.php?doc_no=<?php echo $value["doc_no"]; ?>"><i class="bi bi-check-circle me-1"></i>ส่งงาน</a>
                        <a class="btn btn-secondary" role="button" href="com-show-doc.php?doc_no=<?php echo $value["doc_no"]; ?>"><i class="bi bi-info-circle me-1"></i>ข้อมูล</a>
                      </td>
